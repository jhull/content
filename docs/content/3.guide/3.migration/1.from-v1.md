...
If using Vue components in your `.md` content, make sure you put those components in the `components/content` directory. They won't work if left in the root `components` directory.
